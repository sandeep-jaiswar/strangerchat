        ...
        <div className="flex min-h-screen flex-col bg-slate-950 text-slate-50">
            ...
            <main className="flex flex-1 flex-col items-center justify-center px-4 text-center md:px-6">
                <div className="relative mb-8">
                    ...
                    <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-slate-900 border border-slate-700">
                        <Users className="h-10 w-10 text-indigo-400" />
                    </div>
                </div>

                <h1 className="mb-4 text-5xl font-extrabold tracking-tight md:text-7xl lg:text-8xl">
                    Meet <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-400">Strangers</span>.
                    <br />
                    Make Friends.
                </h1>

                <p className="mx-auto mb-10 max-w-2xl text-lg text-slate-400 md:text-xl">
                    Instantly connect with random people around the world. No downloads, no fuss.
                    Just clean, fast, and anonymous real-time chatting.
                </p>

                <div className="flex flex-col space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                    <Link
                        href="/login"
                        className="group flex items-center justify-center space-x-2 rounded-full bg-indigo-600 px-8 py-4 text-lg font-semibold text-white transition-all hover:bg-indigo-500 hover:scale-105 active:scale-95"
                    >
